...
module "iam" {
  ...
  destiny_insights_backend_consumers_auth_arn = module.dynamodb.destiny_insights_backend_consumers_auth_arn
  destiny_insights_items_arn                   = var.destiny_insights_items_arn
}
